...
sc_trace(tf, in2, "binary_input2"); // signals to be traced
sc_trace(tf, out1, "input_00");
sc_trace(tf, out2, "input_01");
sc_trace(tf, out3, "input_10");
sc_trace(tf, out4, "input_11");
