...
int sc_main(int argc, char *argv[]){
	...
	sc_trace(tf, in_A0, "in_A0");	// signal to be traced
	sc_trace(tf, in_A1, "in_A1");	// signal to be traced
	sc_trace(tf, out_D0, "out_D0");
	sc_trace(tf, out_D1, "out_D1");
	sc_trace(tf, out_D2, "out_D2");
	sc_trace(tf, out_D3, "out_D3");
